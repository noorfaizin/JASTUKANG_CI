				...
				<div class="card-body widget-content">
					<div class="row col-md-10 mx-auto ">
						<div class="col-md-4 mx-auto">
							<img class="img-profile rounded-circle mx-auto d-block" src="<?= base_url('assets/images/user/user.jpg')?>">
							<div class="custom-file mt-3 sm-mb-0 mb-3">
								<input type="file" multiple name="image_name[]" class="custom-file-input" id="gallery-photo-add" required>
								<label class="custom-file-label" for="validatedCustomFile">Ganti foto profile</label>
