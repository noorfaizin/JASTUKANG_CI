...
<head>
  ...
  <title><?= $judul ?></title>
  <link rel="shortcut icon" href="<?= base_url('assets/dist/img/fav-icon.jpg')?>">
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <!-- Font Awesome -->
  <link href="<?= base_url('assets/dist/font-awesome/css/font-awesome.css')?>" rel="stylesheet" />
      ...
      <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin5">
              ...
              <a class="navbar-brand" href="index.html">
                  ...
                  <b class="logo-icon p-l-10">
                      ...
                      <!-- Dark Logo icon -->
                        <img src="<?= base_url('assets/dist/img/logo.png')?>" alt="homepage" class="light-logo" />
                  </b>
                  <!--End Logo icon -->
              </a>
          ...
          <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
              ...
              <ul class="navbar-nav float-right">
                  ...
                  <!-- ============================================================== -->
                  <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('assets/dist/img/users/1.jpg')?>" alt="user" class="rounded-circle" width="31"></a>
