...
<div class="row col-md-11 mx-auto mt-4 p-0">
  <div class="col-md-8">
    <div class="col-md-12 bg-white p-3 mb-3">
      <h4 class="m-0 text-dark">Jasa Renovasi</h4>
    </div>
    ...
    <div class="col-list-3 p-0" style="border-radius:15px">
      <div id="myProduct" class="recent-car-list">
        <div class="col-lg text-dark justify-content-center p-0">
          <a href="<?= base_url('jasa/detailjasa') ?>">
            <div class="card m-0 shadow" style="border-radius:15px">
              ...
              <div class="card-body p-0" style="margin-bottom:-10px;">
                <div class="col-md-12 bg-dark p-2">
                    <h5 class="text-white m-0">Jasa Cat</h5>
                </div>
                <div class="col-md-12 p-2 pb-4">
                  <div class="font-weight-light font-italic text-dark" style="font-size:10px">Kemampuan Tukang :</div>
                  <h5 class="font-weight-light text-success">10 Meter /hari</h5>
                  <div class="font-weight-light font-italic text-dark" style="font-size:10px">Harga :</div>
                  <div class="col-md-12">
                    <h5 class="badge badge-success font-weight-light mr-1">Borongan</h5><small>Rp. 20000 ,-</small>
                  </div>
                  <div class="col-md-12">
                    <h5 class="badge badge-success font-weight-light mr-1">Harian</h5><small>Rp. 100000 ,-</small>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg text-dark justify-content-center p-0">
          <a href="<?= base_url('jasa/detailjasa') ?>">
            <div class="card m-0 shadow" style="border-radius:15px">
              ...
              <div class="card-body p-0" style="margin-bottom:-10px;">
                <div class="col-md-12 bg-dark p-2">
                    <h5 class="text-white m-0">Jasa Listrik</h5>
                </div>
                <div class="col-md-12 p-2 pb-4">
                  <div class="font-weight-light font-italic text-dark" style="font-size:10px">Kemampuan Tukang :</div>
                  <h5 class="font-weight-light text-success">10 Meter /hari</h5>
        ...
        <div class="col-lg text-dark justify-content-center p-0">
          <a href="<?= base_url('jasa/detailjasa') ?>">
            <div class="card m-0 shadow" style="border-radius:15px">
              ...
              <div class="card-body p-0" style="margin-bottom:-10px;">
                <div class="col-md-12 bg-dark p-2">
                    <h5 class="text-white m-0">Jasa Atap</h5>
                </div>
                <div class="col-md-12 p-2 pb-4">
                  <div class="font-weight-light font-italic text-dark" style="font-size:10px">Kemampuan Tukang :</div>
                  <h5 class="font-weight-light text-success">10 Meter /hari</h5>
