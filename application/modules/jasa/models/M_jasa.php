<?php
    ...
    public function getKatSub($table, $kat){
        $this->db->where('id_kategori_jasa', $kat);
    ...
    public function getKategori($id)
    {
        ...
        $query = $this->db->get('jasa')->result_array();
        $kategori = $query['0']['id_kategori'];
        $this->db->where('id_kategori_jasa', $kategori);
        return $this->db->get('jasa_sub_kategori')->result_array();
    }
