<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Ubah Vendor</h1>
  </div>
  ...
  <div class="row">
    <div class="col-10 offset-1">
      <div class="card shadow mb-4">
          <div class="card-body">
            <form method="POST" action="<?= base_url() ?>Vendor/updateVendor" enctype="multipart/form-data">
              <div class="form-group mb-3">
                <label class="form-label">Nama Vendor</label>
                <input type="hidden" class="form-control" name="id_vendor" value="<?php echo $vendor_id?>" required>
                ...
                <div class="row">
                  <div class="col-6">
                    <label for="exampleFormControlSelect1">Kecamatan</label>
                        <select class="form-control kecamatanEdit" name="kecamatanEdit" required>
