<div id="content-wrapper" class="d-flex flex-column">
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <!-- Nav Item - Messages -->
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link" href="<?= base_url('tukang/message')?>">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $this->session->userdata('nama_tukang') ?></span>
            ...
            <a class="dropdown-item" href="<?= base_url('tukang/address')?>">
                <i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>
                Alamat
            </a>
            <a class="dropdown-item" href="<?= base_url('tukang/jasa')?>">
